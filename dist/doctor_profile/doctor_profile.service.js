...
let DoctorProfileService = class DoctorProfileService {
    ...
    async create(StaffReview) {
      ...
      `, [
            ...
            const addReview = await this.connection.query('insert into staff_rating(patient_id,staff_id,review,rating,is_recommended,start_on_time) values (?,?,?,?,?,?)', [StaffReview.patient_id,
                StaffReview.staff_id,
                StaffReview.review,
                StaffReview.rating,
                StaffReview.is_recommended,
...
//# sourceMappingURL=doctor_profile.service.js.map